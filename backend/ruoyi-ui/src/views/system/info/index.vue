<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="一级审核时间，第一次审核的时间，表示审核员对申请的时间戳" align="center" prop="firstApprovalTime" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="二级审核时间，第二次审核的时间，表示二级审核员的审核时间" align="center" prop="secondApprovalTime" width="180">
        <template slot-scope="scope">
