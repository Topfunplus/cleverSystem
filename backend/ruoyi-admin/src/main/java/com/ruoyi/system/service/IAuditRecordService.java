...
public interface IAuditRecordService 
{
     ...
     * 查询用于存储访客审核相关记录的
     * 
     * @param id 用于存储访客审核相关记录的主键
     * @return 用于存储访客审核相关记录的
     */
     ...
     * 查询用于存储访客审核相关记录的列表
     * 
     * @param auditRecord 用于存储访客审核相关记录的
     * @return 用于存储访客审核相关记录的集合
     */
     ...
     * 批量删除用于存储访客审核相关记录的
     * 
     * @param ids 需要删除的用于存储访客审核相关记录的主键集合
     * @return 结果
     */
